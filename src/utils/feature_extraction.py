...
from .dict2vec import DictVectorizer
...
#通过gen_llvm_transform_stats_key.py自动获取的pass_stats_keys，在LLVM17测试
features = {'dse':'NumRedundantStores NumFastStores NumFastOther NumCompletePartials NumModifiedStores',
            ...
            'instcount': 'NumAShrInst NumAddInst NumAllocaInst NumAndInst NumBrInst NumCallInst NumExtractValueInst NumFAddInst NumFCmpInst NumFDivInst NumFMulInst NumFNegInst NumFPExtInst NumFPToSIInst NumFPTruncInst NumFSubInst NumGetElementPtrInst NumICmpInst NumInsertValueInst NumInvokeInst NumLandingPadInst NumLoadInst NumMulInst NumOrInst NumPHIInst NumResumeInst NumRetInst NumSDivInst NumSExtInst NumSIToFPInst NumSRemInst NumSelectInst NumShlInst NumStoreInst NumSubInst NumTruncInst NumZExtInst TotalBlocks TotalFuncs TotalInsts NumBitCastInst NumPtrToIntInst NumIntToPtrInst NumSwitchInst NumUnreachableInst NumFenceInst NumAtomicCmpXchgInst NumAtomicRMWInst'
            }
